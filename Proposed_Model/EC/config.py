...
CEEMDAN_CACHE_DIR = PROJECT_DIR / "CEEMDAN_models" / "decomposed_imfs"
...
def get_config_summary():
    ...
    print(f"Loss: EventWeighted (weight={LOSS_CONFIG['event_weight']})")
...
if __name__ == "__main__":
    ...
    print(f"  CEEMDAN_CACHE: {CEEMDAN_CACHE_DIR}")
